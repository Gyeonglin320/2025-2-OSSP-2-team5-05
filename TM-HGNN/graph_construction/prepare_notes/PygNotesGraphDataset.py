...
import argparse
import os, sys
from graph_construction.prepare_notes.ConstructDatasetByNotes import ConstructDatasetByNotes
...
if __name__ == '__main__':
    ...
    dictionary = open('/data/project/juhyeon/MAGNET/OSS_2/TM-HGNN/data/DATA_RAW/root/vocab.txt').read().split()
