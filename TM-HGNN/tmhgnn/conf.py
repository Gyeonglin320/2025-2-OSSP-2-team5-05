...
def return_paths(a):
    IMDB_PATH = os.path.join(a, './data/hypergraph_out')
    PRE_PATH = os.path.join(a, './data/interim')
    RAW_PATH = os.path.join(a, './data/raw')
...
def parse_arguments(): 
    ...
    # training
    parser.add_argument('-b', '--bsz', default=16, type=int) 
    parser.add_argument('--optimizer', default='AdamW')          
    parser.add_argument('--init-lr', default=2e-5, type=float)     
    ...
    parser.add_argument('--node-features', default=772, type=int)
